...
public class Utils {
    ...
    public static ArrayList<Integer> getRandomChanList(){
	...
	public static boolean checkPhom(ArrayList<Poker> input) throws PhomException{
		if (input.size() < 3) throw new PhomException("Phom co it hon 3 cards");
		Poker[] temp = ArrayListToArray(input);
